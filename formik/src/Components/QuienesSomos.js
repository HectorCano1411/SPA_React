...
const QuienesSomos = () => {
  return (
    <div className="quienes-somos-container">
      ...
      <p>
        Nuestra historia comenzó hace más de una década, cuando un grupo de apasionados por la tecnología se unió para
        crear una empresa que marcara la diferencia. Desde entonces, hemos crecido y evolucionado, pero nuestra pasión
        por la excelencia y la entrega de resultados excepcionales sigue siendo el núcleo de nuestra cultura empresarial.
      </p>
      <p>
